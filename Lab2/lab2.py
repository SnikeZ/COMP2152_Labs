...
if (weaponRoll != 0): print("Thank goodness you didn't roll the Fist...")
...
# Equality operators
print("--- You are matched in strength: " +
      str(combatStrength == mCombatStrength))

# Relational operators
print("--- You have a strong player: " +
      str((combatStrength + healthPoints) >= 15))

# and keyword
print("--- Remember to take a healing potion!: " +
      str(healingPotion == 1 and healthPoints <= 6))
...
# or keyword
print("--- Things are getting dangerous: " +
      str(healingPotion == 0 or healthPoints == 1))
...
if healthPoints >= 5:
    ...
    print("--- Your health is low at " + str(healthPoints) +
          " and you have no healing potions available!")
...
print("Your sword (" + str(combatStrength) +
...
if combatStrength >= mHealthPoints:
    ...
    print("Monster's Claw (" + str(mCombatStrength) +
          ") ---> You (" + str(healthPoints) + ")")
